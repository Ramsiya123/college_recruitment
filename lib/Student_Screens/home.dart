...
String getCurrentDate() {
  // Get the current date and format it with the short month name
  DateTime now = DateTime.now();
  String formattedDate = DateFormat('dd \nMMM', 'en_US').format(now);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {},
            icon: Icon(Icons.bookmark_border_rounded, color: Colors.blue, size: 35),
          ),
          IconButton(
            onPressed: () {},
            icon: Icon(Icons.notifications_none, color: Colors.blue, size: 35),
          ),
        ],
      ),
      backgroundColor: Colors.white,
                        ...
                        children: [
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: IconButton(
                                      onPressed: () {},
                                      icon: Icon(Icons.bookmark_border, color: Colors.blue, size: 18,),
                                    ),
                                  ),
                                ),
                              ),
                          ...
                          Row(
                            children: [
                              ...
                              Small_Text(text: "Trivandram, Kerala", color: Colors.grey, size: 13,),
                            ],
                          ),
                        ],
                      ),
