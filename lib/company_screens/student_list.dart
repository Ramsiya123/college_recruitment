                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        padding: const EdgeInsets.only(left: 10,bottom:14.0,right: 10),
                        ...
                        child: InkWell(
                          ...
                          onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>REcruitment(),));},
                          ...
                          children: [
                            ...
                            Image.asset("images/pdf.png", width: 18, height: 18),
      
                            Small_Text(text: "Resume", size: 14, color: const Color.fromARGB(255, 80, 79, 79)),
                                ...
                                trailing:IconButton(onPressed: (){}, icon: Icon(Icons.arrow_forward_ios,color: Colors.black,)),
